...
target_files = [
    "src/components/services/VastuConsultancyContent.jsx",
    "src/components/services/PropertyInvestmentGurgaonContent.jsx",
    "src/components/services/BestRealEstateCompanyGurgaonContent.jsx",
    "src/components/ddjay/WhatIsDDJAYContent.jsx",
    "src/components/ddjay/DDJAYEligibilityContent.jsx",
    "src/components/ddjay/DDJAYLoanContent.jsx",
    "src/components/ddjay/DeenDayalPlotsGurgaon2026Content.jsx",
]
