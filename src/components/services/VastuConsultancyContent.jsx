...
export default function VastuConsultancyContent() {
  const [activeStep, setActiveStep] = useState(0);

  const offerings = [
    {
      icon: <TrendingUp className="w-6 h-6 text-[#B51F3B]" />,
    ...
    {
      icon: <Home className="w-6 h-6 text-[#B51F3B]" />,
    ...
    {
      icon: <Building2 className="w-6 h-6 text-[#B51F3B]" />,
    ...
    {
      icon: <MapPin className="w-6 h-6 text-[#B51F3B]" />,
    ...
    {
      icon: <Search className="w-6 h-6 text-[#B51F3B]" />,
    ...
    {
      icon: <BarChart3 className="w-6 h-6 text-[#B51F3B]" />,
    ...
    <section className="bg-[#fcfcfc] min-h-screen pt-32 pb-24 px-4 sm:px-6 md:px-12 font-sans text-neutral-800">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-neutral-200/80 shadow-sm mb-16">
          <div className="max-w-3xl">
            ...
            <p className="text-neutral-600 text-sm sm:text-base leading-relaxed font-medium">
              Vastu Consultancy provides personalised property investment guidance based on your requirements, investment horizon, budget, and objectives.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {whyUs.map((w, idx) => (
                <div key={idx} className="bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-white/10">
                  <div className="flex items-center gap-3 mb-3">
                    <CheckCircle2 className="w-5 h-5 text-[#B51F3B] flex-shrink-0" />
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-neutral-200/80 shadow-sm mb-16">
          <div className="flex flex-col items-start mb-10">
            ...
            <p className="text-neutral-600 text-sm mt-2">
              Vastu Consultancy works with individuals and investors looking for professional guidance across different real estate segments.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-neutral-900 via-[#0c0d12] to-neutral-900 text-white rounded-3xl p-8 sm:p-12 mb-16 border border-neutral-800 shadow-2xl relative overflow-hidden">
          <div className="relative z-10 max-w-3xl">
            ...
            <p className="text-neutral-300 text-sm sm:text-base leading-relaxed mb-8">
              The right investment starts with the right evaluation. From selecting the right location to understanding the potential of a property, Vastu Consultancy helps you approach real estate investment with greater clarity and confidence.
            </p>
            <Link
              href="/contact"
            ...
            >
              <span>Connect With Vastu Consultancy</span>
              <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
        ...
        <div className="bg-amber-50/60 border border-amber-200 p-6 rounded-2xl text-amber-950 text-xs leading-relaxed">
          ...
          <p>
            Property investment involves market risks, and returns are not guaranteed. Information provided by Vastu Consultancy is for general informational and consultancy purposes only and should not be considered financial, legal, or investment advice. Investors should independently verify property, regulatory, legal, pricing, and financial information before making any investment decision.
          </p>
        </div>
